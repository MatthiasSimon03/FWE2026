...
class Rallies extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/rallies/list', ['rallies' => $rallies]);
    }
    ...
    public function create()
    {
        ...
        if ($this->request->is('post')) {
            ...
            return redirect()->to(site_url('admin/rallies'))->with('success', 'Rallye erstellt.');
        }

        return view('admin/rallies/create');
    }
    ...
    public function edit($rallyId)
    {
        ...
        if ($this->request->is('post')) {
            ...
            return redirect()->to(site_url('admin/rallies'))->with('success', 'Rallye aktualisiert.');
        }

        return view('admin/rallies/edit', ['rally' => $rally]);
    }
    ...
    public function delete($rallyId)
    {
        ...
        return redirect()->to(site_url('admin/rallies'))->with('success', 'Rallye gelöscht.');
    }
}
